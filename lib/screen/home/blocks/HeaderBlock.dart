    ...
    showMenu(
      ...
      items: [
        PopupMenuItem(
          enabled: false,
          child: MouseRegion(
            // Auto-hide when the pointer leaves the menu
      ...
      return Column(
        children: [
          ...
          _buildMobileContactItem(
            ...
            onTap: () async {
              Navigator.pop(context);
              final Uri telUri = Uri(scheme: 'tel', path: '+917306124112');
              if (await canLaunchUrl(telUri)) {
                await launchUrl(telUri);
              }
            },
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: const LinearGradient(
            colors: [Color(0xFF9D50FF), Color.fromARGB(255, 110, 12, 192)],
          ),
        ),
        child: TextButton(
          onPressed: () async {
            ...
            child: TextButton(
              onPressed: () async {
                ...
                if (eventType == 'technical') {
                  final Uri _registerUri =
                      Uri.parse('https://www.dikshaiet.com/technical-events');
